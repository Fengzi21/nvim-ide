...
dashboard.section.header.val = headers.lambda
...
dashboard.section.footer.val = footers[0]
dashboard.section.footer.opts.hl = "Type"

alpha.setup(dashboard.config) ---@diagnostic disable-line: redundant-parameter
